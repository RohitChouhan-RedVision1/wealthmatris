        ...
        <DefaultLayout>
            <div className="mb-6">
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-2">
                    ...
                    className={activeTab === "contactus" ? "text-white bg-[var(--rv-primary)]" : ""}
                    ...
                    <Button
                    className={activeTab === "riskprofile" ? "text-white bg-[var(--rv-primary)]" : ""}
                    ...
                    <Button
                    className={activeTab === "healthprofile" ? "text-white bg-[var(--rv-primary)]" : ""}
