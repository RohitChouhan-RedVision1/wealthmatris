...
const DataTableDemo = () => {
    ...
    const handleDelete = async (id) => {
        try {
            const res = await axios.delete(`/api/homebanner/${id}`);
            if (res.status === 200) {
    ...
    const columns = [
        ...
        },
        {
            ...
            header: "Auther url",
            cell: ({ row }) => <div>{row.getValue("auther_url")}</div>,
        },
        {
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-[var(--rv-primary)] text-white" align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem onClick={() => router.push(`/admin/manage-homebanner/edit-post/${blog._id}`)}>
                                Edit
                            </DropdownMenuItem>
