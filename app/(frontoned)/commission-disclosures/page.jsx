...
const CommissionDisclosurePage = () => {
  return (
    <div>
      {/* Header Section */}
      <div className="bg-[var(--rv-primary)] pt-[130px] pb-[50px] text-center">
        <h1 className="text-5xl font-bold text-white">Commission Disclosures</h1>
      </div>

      {/* Table Section */}
      <div className="container mx-auto px-4 md:px-32 py-12">
      <h1 className="text-2xl text-center font-bold text-[var(--rv-primary)] mb-2">Commission Disclosure under SEBI Circular SEBI/IMD/CIR No.4 /168230/09</h1>
          ...
          <TableBody>
            {commissionData.map((item, index) => (
              <TableRow key={index} className="border-b">
                <TableCell className="px-4 py-3 font-semibold text-gray-800 bg-[var(--rv-primary)]">{item.scheme}</TableCell>
                <TableCell className="px-4 py-3 text-gray-700 bg-[var(--rv-primary)]">{item.trail1}</TableCell>
                <TableCell className="px-4 py-3 text-gray-700 bg-[var(--rv-primary)]">{item.trail2}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
