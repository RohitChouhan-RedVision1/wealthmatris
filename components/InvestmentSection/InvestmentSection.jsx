...
export default function InvestmentSection() {
  return (
    <div
      className=" bg-[#b2b2b21f] main_section relative overflow-x-hidden"
    ...
    >
      ...
      variants={fadeInFromLeft} className="max-w-5xl mx-auto">
        <h2 className="subheading text-[var(--rv-primary)] mb-4 text-center">
        ...
        <div className="flex flex-col md:flex-row  items-center gap-8 p-10">
          <div className="text-center ">
            <div className="flex justify-center mb-4">
              <div className="w-14 h-14 items-end bg-[var(--rv-secondary)]/60 rounded-full">
                <Image src="/Vector (2).png" alt="Invest" height={150} width={150} />
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[var(--rv-primary)] mb-4">Invest</h2>
          ...
          <div className="hidden md:block border-l border-gray-300 h-52"></div>
          ...
          <div className="text-center ">
            ...
            <h2 className="text-2xl font-bold text-[var(--rv-primary)] mb-4">Restructure</h2>
            <p className="text-md text-[#333]">
          ...
          <div className="text-center ">
            ...
            <h2 className="text-2xl font-bold text-[var(--rv-primary)] mb-4">Liquidate</h2>
            <p className="text-md text-[#333]">
